...
from src.interface.future import Future
from src.interface.spot import Spot
from src.interface.wallet import Wallet
...
class Exchange:
    ...
    def __import_class(exchange: str, module_name: str, file_name: str):
        module_path = f"src.exchanges.{exchange}.{module_name}.{file_name}"
